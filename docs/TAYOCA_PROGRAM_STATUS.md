...
| Forgejo → GitHub → Vercel deployment parity | DONE | The canonical Forgejo tree is mirrored downstream to GitHub and deployed from GitHub `main` to the Tayoca Vercel production project. Parity was re-certified after the 2026-08-30 external-gate merge; future evidence should be derived from current live heads/deployments rather than embedding a self-referential “latest SHA” in this status row. |
